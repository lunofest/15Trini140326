const CACHE_NAME = 'cache-v84'; // Use a static or manually managed version
const RESOURCES_TO_PRECACHE = [
    'estilos/normalize.css?v84',
    'estilos/styles.css?v84',
    'estilos/mediaQueries.css?v84',
    'javascript/script.js?v84',
